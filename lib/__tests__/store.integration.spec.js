...
describe('Integration Test', () => {
  ...
  describe('down command', () => {
    ...
    it('-d option should not apply down migration @integration', async () => {
      spawnSync(
        NODE_CMD,
  ...
  describe('bootstrap command', () => {
    ...
    it('-c option creates script for content type @integration', async () => {
      ...
      spawnSync(
        NODE_CMD,
        [MIGRATION_CMD, 'bootstrap', '-c', contentType, ...TOKEN_SPACE_ENV_OPTIONS]
      );
    ...
    it('-a option creates script for content type @integration', async () => {
      const contentTypeOptions = {
        name: 'Alpaca',
        fields: [{
          id: 'name',
      ...
      spawnSync(
        NODE_CMD,
        [MIGRATION_CMD, 'bootstrap', '-a', ...TOKEN_SPACE_ENV_OPTIONS]
      );
    ...
    it('--danger-will-robinson-danger with -c overrides the state for specific content type @integration', async () => {
      const command = `yes | ${MIGRATION_CMD} bootstrap -c ${contentType} --danger-will-robinson-danger ${TOKEN_SPACE_ENV_OPTIONS.join(' ')}`;
      execSync(command);
    ...
    it('--danger-will-robinson-danger with -a overrides the state for all content type @integration', async () => {
